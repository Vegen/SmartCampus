...
import com.itculturalfestival.smartcampus.ui.activity.team.CreateTeamActivity;
import com.itculturalfestival.smartcampus.ui.activity.team.FoundTeamActivity;
    ...
    private void elv_teamListener(){
        elv_team.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                if (i == 0){
                    TeamIntroduceActivity.actionStart(getContext(), childArray.get(i).get(i1).getWhat());
                }
                return false;
            }
        });
