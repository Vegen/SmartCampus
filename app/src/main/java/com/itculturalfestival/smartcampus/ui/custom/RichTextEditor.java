 ...
 * @describe: 富文本编辑器，给外部提供insertImage接口，添加的图片跟当前光标所在位置有关
 */

public class RichTextEditor extends ScrollView {
    private static final int EDIT_PADDING = 5; // edittext常规padding是10dp
    private static final int EDIT_FIRST_PADDING_TOP = 5; // 第一个EditText的paddingTop值
    ...
    public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        EditText firstEdit = createEditText("输入内容...",
    ...
    private EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout.view_edit_item1,
                null);
